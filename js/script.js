...
async function main() {
    ...
    currentSong.addEventListener("timeupdate", () => {
        ...
        document.querySelector(".circle").style.left = (currentSong.currentTime / currentSong.duration) * 100 + "%";//seekbar
    })
...
// let a= "Se%C3%B1orita%20-%20Shawn%20Mendes.mp3"
// undefined
// a.split("Mendes")
// (2) ['Se%C3%B1orita%20-%20Shawn%20', '.mp3']